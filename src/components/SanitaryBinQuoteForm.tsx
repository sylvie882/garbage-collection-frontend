    ...
    <section className="bg-gray-50 py-20">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          {/* Right Column - Image */}
          <div className="relative rounded-2xl overflow-hidden h-[500px] lg:h-[600px] shadow-xl">
            <Image
              src="/images/faq-image.png"
              alt="Sanitary bin service technician servicing a bin in a modern washroom"
              fill
              className="object-cover"
              sizes="(max-width: 768px) 100vw, 50vw"
            />
            {/* Optional overlay with stats or quote */}
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-green-900/90 to-transparent p-6">
              <div className="text-white">
                <p className="text-lg font-bold mb-2">Trusted by 500+ businesses</p>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <div className="text-2xl font-extrabold">47</div>
                    <div className="text-sm text-green-200">Counties Served</div>
                  </div>
                  <div>
