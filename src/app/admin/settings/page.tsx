...
export default function SettingsPage() {
  ...
  const fetchAdminData = async () => {
    try {
      const token = localStorage.getItem('adminToken');
      const response = await fetch('https://www.sylviegarbagecollection.co.ke/api/public/api/admin/me', {
        headers: {
  ...
  const updateProfile = async (e: React.FormEvent) => {
    ...
    try {
      const token = localStorage.getItem('adminToken');
      const response = await fetch('https://www.sylviegarbagecollection.co.ke/api/public/api/admin/profile', {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
  ...
  const changePassword = async (e: React.FormEvent) => {
    ...
    try {
      const token = localStorage.getItem('adminToken');
      const response = await fetch('https://www.sylviegarbagecollection.co.ke/api/public/api/admin/change-password', {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const handleLogout = async () => {
    try {
      const token = localStorage.getItem('adminToken');
      await fetch('https://www.sylviegarbagecollection.co.ke/api/public/api/admin/logout', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Accept': 'application/json',
