...
export const metadata: Metadata = {
  ...
  alternates: {
  canonical: 'https://www.sylviegarbagecollection.co.ke',
},
  openGraph: {
    ...
    images: [
      {
        url: 'https://www.sylviegarbagecollection.co.ke/og-image.jpg',
        width: 1200,
        height: 630,
  ...
  metadataBase: new URL('https://www.sylviegarbagecollection.co.ke'),
