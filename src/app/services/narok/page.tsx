    ...
    <div className="min-h-screen bg-slate-50 pt-[72px]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <section className="bg-green-800 py-16 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <p className="text-xs font-bold uppercase tracking-widest text-green-300 mb-3">Narok County</p>
          ...
          <p className="text-green-200 text-lg max-w-2xl mx-auto leading-relaxed">
            Professional waste management solutions serving 6 major areas locations across Narok County. Reliable, eco-friendly collection for homes and businesses.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold text-slate-900" style={{ fontFamily: "'Fraunces', serif" }}>
              Service Areas in <span className="text-green-700">Narok</span>
            </h2>
          </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold text-slate-900" style={{ fontFamily: "'Fraunces', serif" }}>
              Narok Waste Management Solutions
            </h2>
          </div>
      ...
      <section className="py-16 bg-green-800">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4" style={{ fontFamily: "'Fraunces', serif" }}>
            Ready for Reliable Waste Management in Narok?
          </h2>
