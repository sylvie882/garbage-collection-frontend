...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-4 w-full overflow-x-hidden">
            ...
            {[
              ...
              <div key={index} className="group">
                <div className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                  <div className={`w-20 h-20 mx-auto mb-6 rounded-2xl ${feature.color} flex items-center justify-center text-3xl text-white shadow-md group-hover:scale-105 transition-transform duration-300`}>
                    {feature.icon}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          {displayedServices.length > 0 ? (
            <>
              ...
              {services.length > 6 && (
                <div className="text-center">
                  <Link 
                    href="/services"
                    className="bg-green-600 text-white px-12 py-4 rounded-xl text-lg font-semibold hover:bg-green-700 transition-colors duration-200 inline-flex items-center gap-3 shadow-lg"
                  >
            ...
            <div className="text-center py-16">
              <div className="w-24 h-24 bg-green-100 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-md">
              ...
              <Link 
                href="/contact"
                className="bg-green-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-green-700 transition-colors duration-200 inline-flex items-center gap-3"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            {[
              ...
              >
                <div className="relative bg-white rounded-2xl p-8 text-center h-full transform hover:-translate-y-2 transition-all duration-300 shadow-lg hover:shadow-xl border border-gray-100">
                  <div className={`w-16 h-16 mx-auto mb-6 rounded-2xl ${county.color} flex items-center justify-center text-white text-2xl font-bold group-hover:scale-105 transition-transform duration-300 shadow-md`}>
                    {county.icon}
                  </div>
          ...
          <div className="bg-green-50 rounded-2xl p-8 mb-12 shadow-lg border border-green-100">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              {[
                ...
                <Link 
                  key={index}
                  href={service.href} 
                  className={`${service.color} px-6 py-3 rounded-lg font-semibold transition-colors duration-200 inline-flex items-center gap-2 shadow-md`}
                >
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/coverage"
                className="bg-green-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors duration-200 inline-flex items-center gap-2 shadow-lg"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link 
                href="/contact"
                className="bg-white text-green-600 border-2 border-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-green-50 transition-colors duration-200 inline-flex items-center gap-2 shadow-lg"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
      ...
      <section className="py-20 bg-green-800">
        <div className="max-w-4xl mx-auto px-4 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link 
              href="/quote" 
              className="bg-orange-500 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-orange-600 transition-colors duration-200 inline-flex items-center gap-3 shadow-lg"
            >
              Get Free Quote
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link 
              href="/contact" 
              className="bg-white text-green-800 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-gray-100 transition-colors duration-200 border-2 border-transparent shadow-lg"
            >
              Contact Us
            </Link>
          </div>
